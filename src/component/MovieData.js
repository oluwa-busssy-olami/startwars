  ...
  return (
    <div className="main-container">
      ...
      <div className="data-wrapper">
        {" "}
        {/*loadingg phrase when you are trying to fetch data */}{" "}
        {loading && <div className="fetch-data"> Fetching Movies..... </div>}{" "}
        {error && (
          <div className="error">
            {" "}
            {`There's a problem fetching the movie-data _ ${error}`}{" "}
          </div>
        )}{" "}
        <ul className="movie-data-card">
          {" "}
          {data &&
            data.map((item) => {
              return (
                <li key={item.episode_id} className="list-movie">
